...
/**
 * Handle KV operations for message history
  ...
  try {
    switch (action) {
      ...
      case 'put': {
        ...
        await MESSAGES_KV.put(body.key, JSON.stringify(body.value), options);
      ...
      case 'list': {
        ...
        const result = await MESSAGES_KV.list(listOptions);
