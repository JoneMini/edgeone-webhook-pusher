// Edge Function: Apps KV Operations
// Path: /api/kv/apps
  ...
  try {
    switch (action) {
      case 'get': {
        ...
        const data = await APPS_KV.get(key, 'json');
      ...
      case 'put': {
        ...
        await APPS_KV.put(body.key, JSON.stringify(body.value), options);
      ...
      case 'list': {
        ...
        const result = await APPS_KV.list(listOptions);
